...
router.post(['/upsert/', '/upsert/:id'], checkPermission('documentStores:upsert-config'), getMulterStorage().array('files'), documentStoreController.upsertDocStoreMiddleware)

router.post(['/refresh/', '/refresh/:id'], checkPermission('documentStores:upsert-config'), documentStoreController.refreshDocStoreMiddleware)
...
router.put('/store/:id', checkAnyPermission('documentStores:update'), documentStoreController.updateDocumentStore)
...
router.post('/generate-tool-desc/:id', checkPermission('documentStores:update'), documentStoreController.generateDocStoreToolDesc)
