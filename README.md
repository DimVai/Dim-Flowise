...
| Dynamic chat models                 | OpenAI, Anthropic, and Google Gemini **chat model lists are kept up to date** by refreshing them from Models.dev at startup. Other integrations retain their base lists. Set `DISABLE_DYNAMIC_MODELS=true` to disable the refresh. See [Model catalog](CONFIGURATION.md#model-catalog) for storage, filtering, and compatibility details.                                                                                                               |
