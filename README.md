...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Upstream sunset banner removed      | The application no longer displays the upstream Flowise sunset announcement.                                                                                                                                                                                                                                                                                                                                                                            |
| Up-to-date chat models              | At startup, the application refreshes the **chat model lists** for OpenAI, Anthropic, and Google Gemini from Models.dev. Models from other providers use their base lists. Set `DISABLE_DYNAMIC_MODELS=true` to disable the refresh and/or use `MODEL_LIST_CONFIG_JSON` to specify a model-list JSON file. See [Model catalog](CONFIGURATION.md#model-catalog) for storage, filtering, and compatibility details.                                       |
